...
$THEME->name = 'unitec_corporate_shs';

// The only thing you need to change in this file when copying it to
// create a new theme is the name above. You also need to change the name
// in version.php and lang/en/theme_unitec_corporate_shs.php as well.
...
$THEME->csspostprocess = 'theme_unitec_corporate_shs_process_css';
